    ...
    return (
        <Stack direction="row" justifyContent="center" spacing={props.size / 64} sx={props.sx}>
            <svg viewBox="0 0 24 24" height={props.size}>
                <path style={{ fill: useTheme().palette.primary.main }} d="M17,7.9l-4.9,4.9L8.5,9.4l4.9-4.9L17,7.9z M12.8,2.3L6.4,8.7c-0.4,0.4-0.4,1,0,1.4l5,4.9c0.4,0.4,1,0.4,1.4,0
